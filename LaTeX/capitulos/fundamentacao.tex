...
A arquitetura do ROS é baseada em Grafos, e suas aplicações práticas possuem diversos nós, que se comunicam entre si por meio de Mensagens enviadas pelos Tópicos, usando os conceitos de Publisher-Subscriber. Nós muitas vezes são uma combinação complexa de publishers e subscribers.

ROS permite a escrita de seus pacotes nas linguagens Python e C++, e o uso simultâneo de diversos pacotes, escritos em linguagens diferentes. A comunidade que suporta o framework disponibiliza diversos pacotes e integrações com hardwares existentes, o que torna o uso da ferramenta mais prático e ágil.
