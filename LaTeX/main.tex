...
\lstdefinelanguage{AADL}{
  keywords={data, features, properties, in, event, data, thread, process, package, public, with, system, device, end, implementation, subcomponents, connections, port, feature},
